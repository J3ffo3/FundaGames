...
{
	Animation moveR = Animation(0, 7, 100);
	Animation moveL = Animation(1, 7, 100);
	Animation moveD = Animation(2, 7, 100);
	Animation moveU = Animation(3, 7, 100);

	animations.emplace("Move Right", moveR);
	animations.emplace("Move Left", moveL);
	animations.emplace("Move Down", moveD);
	animations.emplace("Move Up", moveU);
}
